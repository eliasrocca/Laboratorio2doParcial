...
class NivelDos(Nivel):
    def __init__(self,pantalla: pygame.Surface):
        ...
        enemigo_1 = Enemigo(675,567,40,40,"Laboratorio2doParcial/fotos/enemigo_2_dif.png")
        enemigo_3 = Enemigo(675,446,40,40,"Laboratorio2doParcial/fotos/enemigo_2_dif.png")
        enemigo_estatic = Enemigo_estatico(1075,550,60,60,"Laboratorio2doParcial/fotos/enemigo_planta_1.png")
        ...
        lista_plataformas = [plataforma_piso,plataforma_1,plataforma_2,plataforma_8,plataforma_11,plataforma_12,plataforma_3,plataforma_4,plataforma_5,
                            plataforma_6,plataforma_7,plataforma_9,plataforma_10,plataforma_13
                            ]

        lista_consumibles = [consumibles,consumible_2]

        lista_enemigos = [enemigo_1,enemigo_3]

        lista_enemigos_2 = [enemigo_estatic]
